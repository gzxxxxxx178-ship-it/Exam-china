...
class Position(Base, TimestampMixin):
    ...
    institution_nature: Mapped[str | None] = mapped_column(String(120))
    position_attribute: Mapped[str | None] = mapped_column(String(120))
    position_distribution: Mapped[str | None] = mapped_column(String(120))
    description: Mapped[str | None] = mapped_column(Text)
    institution_level: Mapped[str | None] = mapped_column(String(80))
    exam_category: Mapped[str | None] = mapped_column(String(160))
    ...
    service_project_experience: Mapped[str | None] = mapped_column(String(200))
    professional_test_required: Mapped[str | None] = mapped_column(String(40))
    interview_ratio: Mapped[str | None] = mapped_column(String(40))
    ...
    settlement_location: Mapped[str | None] = mapped_column(String(300))
    department_website: Mapped[str | None] = mapped_column(Text)
    contact_phone: Mapped[str | None] = mapped_column(String(300))
